...
define(["exports", "react", "classnames", "antd4mx/_util/colors", "antd4mx/config-provider", "antd4mx/badge/style/ribbon"], function (_exports, React, _classnames, _colors, _configProvider, _ribbon) {
  ...
  var Ribbon = function Ribbon(props) {
    ...
    var _useStyle = (0, _ribbon["default"])(prefixCls, wrapperCls),
      _useStyle2 = _slicedToArray(_useStyle, 3),
      wrapCSSVar = _useStyle2[0],
      hashId = _useStyle2[1],
      cssVarCls = _useStyle2[2];
    var colorInPreset = (0, _colors.isPresetColor)(color, false);
    var ribbonCls = (0, _classnames["default"])(prefixCls, "".concat(prefixCls, "-placement-").concat(placement), _defineProperty(_defineProperty({}, "".concat(prefixCls, "-rtl"), direction === 'rtl'), "".concat(prefixCls, "-color-").concat(color), colorInPreset), className);
    var colorStyle = {};
  ...
  var _default = _exports["default"] = Ribbon;
});