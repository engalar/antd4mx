...
define(["exports", "react", "@ant-design/icons/es/icons/CalendarOutlined", "@ant-design/icons/es/icons/ClockCircleOutlined", "@ant-design/icons/es/icons/SwapRightOutlined", "classnames", "rc-picker", "antd4mx/_util/hooks/useZIndex", "antd4mx/_util/statusUtils", "antd4mx/_util/warning", "antd4mx/config-provider", "antd4mx/config-provider/DisabledContext", "antd4mx/config-provider/hooks/useCSSVarCls", "antd4mx/config-provider/hooks/useSize", "antd4mx/form/context", "antd4mx/form/hooks/useVariants", "antd4mx/locale", "antd4mx/space/Compact", "antd4mx/date-picker/locale/en_US", "antd4mx/date-picker/style", "antd4mx/date-picker/util", "antd4mx/date-picker/generatePicker/useComponents"], function (_exports, _react, _CalendarOutlined, _ClockCircleOutlined, _SwapRightOutlined, _classnames, _rcPicker, _useZIndex3, _statusUtils, _warning, _configProvider, _DisabledContext, _useCSSVarCls, _useSize, _context, _useVariants, _locale, _Compact, _en_US, _style, _util, _useComponents) {
  "use strict";
  "use client";
  ...
  function generateRangePicker(generateConfig) {
    var RangePicker = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
      ...
      var _useLocale = (0, _locale.useLocale)('Calendar', _en_US["default"]),
