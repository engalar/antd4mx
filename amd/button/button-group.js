...
define(["exports", "react", "classnames", "antd4mx/_util/warning", "antd4mx/config-provider/index", "antd4mx/theme/internal"], function (_exports, React, _classnames, _warning, _index, _internal) {
  ...
  _exports["default"] = _exports.GroupSizeContext = void 0;
  ...
  var ButtonGroup = function ButtonGroup(props) {
    ...
    if (process.env.NODE_ENV !== 'production') {
      var warning = (0, _warning.devUseWarning)('Button.Group');
      process.env.NODE_ENV !== "production" ? warning(!size || ['large', 'small', 'middle'].includes(size), 'usage', 'Invalid prop `size`.') : void 0;
    }
    var classes = (0, _classnames["default"])(prefixCls, _defineProperty(_defineProperty({}, "".concat(prefixCls, "-").concat(sizeCls), sizeCls), "".concat(prefixCls, "-rtl"), direction === 'rtl'), className, hashId);
  ...
  var _default = _exports["default"] = ButtonGroup;
});