define(["exports", "react", "antd4mx/color-picker/util", "antd4mx/color-picker/components/ColorSteppers"], function (_exports, _react, _util, _ColorSteppers) {
  ...
  var ColorHsbInput = function ColorHsbInput(_ref) {
    ...
    var handleHsbChange = function handleHsbChange(step, type) {
      ...
      var genColor = (0, _util.generateColor)(hsb);
      if (!value) {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      formatter: function formatter(step) {
        return (0, _util.getRoundNumber)(step || 0).toString();
      },
      ...
      className: colorHsbInputPrefixCls,
      formatter: function formatter(step) {
        return "".concat((0, _util.getRoundNumber)(step || 0), "%");
      },
      onChange: function onChange(step) {
  ...
  var _default = _exports["default"] = ColorHsbInput;
});