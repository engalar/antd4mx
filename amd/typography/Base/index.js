  ...
  var Base = /*#__PURE__*/React.forwardRef(function (props, ref) {
    ...
    var renderCopy = function renderCopy() {
      ...
      return /*#__PURE__*/React.createElement(_tooltip["default"], {
        ...
        className: (0, _classnames["default"])("".concat(prefixCls, "-copy"), _defineProperty(_defineProperty({}, "".concat(prefixCls, "-copy-success"), copied), "".concat(prefixCls, "-copy-icon-only"), children === null || children === undefined)),
        onClick: onCopyClick,
        "aria-label": ariaLabel
    ...
    return /*#__PURE__*/React.createElement(_rcResizeObserver["default"], {
      ...
      return /*#__PURE__*/React.createElement(_EllipsisTooltip["default"], {
        ...
        className: (0, _classnames["default"])(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-").concat(type), type), "".concat(prefixCls, "-disabled"), disabled), "".concat(prefixCls, "-ellipsis"), enableEllipsis), "".concat(prefixCls, "-single-line"), mergedEnableEllipsis && rows === 1), "".concat(prefixCls, "-ellipsis-single-line"), cssTextOverflow), "".concat(prefixCls, "-ellipsis-multiple-line"), cssLineClamp), className),
