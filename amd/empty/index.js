...
define(["exports", "classnames", "react", "antd4mx/config-provider/index", "antd4mx/locale/index", "antd4mx/empty/empty", "antd4mx/empty/simple", "antd4mx/empty/style/index"], function (_exports, _classnames, React, _index, _index2, _empty, _simple, _index3) {
  ...
  var Empty = function Empty(_a) {
    ...
    return wrapCSSVar( /*#__PURE__*/React.createElement("div", Object.assign({
      className: (0, _classnames["default"])(hashId, cssVarCls, prefixCls, empty === null || empty === void 0 ? void 0 : empty.className, _defineProperty(_defineProperty({}, "".concat(prefixCls, "-normal"), image === simpleEmptyImg), "".concat(prefixCls, "-rtl"), direction === 'rtl'), className, rootClassName),
  ...
  var _default = _exports["default"] = Empty;
});