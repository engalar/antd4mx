define(["exports", "rc-pagination/es/locale/bg_BG", "antd4mx/calendar/locale/bg_BG", "antd4mx/date-picker/locale/bg_BG", "antd4mx/time-picker/locale/bg_BG"], function (_exports, _bg_BG, _bg_BG2, _bg_BG3, _bg_BG4) {
  "use strict";
  ...
  var typeTemplate = '${label} не е валиден ${type}';
  var localeValues = {
    locale: 'bg',
